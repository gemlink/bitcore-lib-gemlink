...
function addNetwork(data) {
  ...
  networkMaps[network.coin] = network;
...
coins.coinList.forEach(element => {
  addNetwork({
    coin: element.coin,
    name: element.name,
    alias: element.alias,
    pubkeyhash: element.pubKeyHash,
    privatekey: element.wif,
    scripthash: element.scriptHash,
    xpubkey: element.bip32.public,
    xprivkey: element.bip32.private,
    zaddr: element.zaddr,
    zkey: element.zkey,
    networkMagic: element.networkMagic,
    port: element.port,
    dnsSeeds: element.dnsSeeds
  });
});
